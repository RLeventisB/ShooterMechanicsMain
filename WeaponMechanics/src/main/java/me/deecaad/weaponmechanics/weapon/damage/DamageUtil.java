...
public class DamageUtil
{
     ...
     */
    public static boolean apply(LivingEntity cause, LivingEntity victim, double damage, String weaponTitle, boolean isHeadshot, boolean isExplosion, ItemStack weaponStack)
    {
        ...
        EntityDamageByEntityEvent entityDamageByEntityEvent = new WeaponMechanicsEntityDamageByEntityEvent(cause, victim, EntityDamageEvent.DamageCause.PROJECTILE, damage, weaponTitle, isHeadshot, isExplosion, weaponStack);
